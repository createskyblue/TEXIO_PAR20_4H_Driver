...
async def set_voltage(request: SetVoltageRequest):
    ...
    response = controller.set_voltage(request.voltage, request.memoryObj)
    controller.close()
    return response
...
async def set_current(request: SetCurrentRequest):
    controller = DeviceController(port='COM47')
    response = controller.set_current(request.current, request.is_uaAccuracy, request.memoryObj)
    controller.close()
    return response
...
async def select_output(request: SelectOutputRequest):
    controller = DeviceController(port='COM47')
    response = controller.select_output(request.memoryObj)
    controller.close()
    return response
...
async def control_output(enable: bool):
    controller = DeviceController(port='COM47')
    response = controller.control_output(enable)
    controller.close()
    return response
...
async def toggle_protection(enable: bool = True):
    controller = DeviceController(port='COM47')
    controller.toggle_protection(enable)
    controller.close()
    return {"code": 0, "msg": "Success"}
...
async def set_ua_accuracy(enable: bool):
    controller = DeviceController(port='COM47')
    controller.set_ua_accuracy(enable)
    controller.close()
    return {"code": 0, "msg": "Success"}
...
async def get_output_status():
    controller = DeviceController(port='COM47')
    response = controller.getOutputStatus()
    controller.close()
    return response
...
async def get_memory_preset():
    controller = DeviceController(port='COM47')
    response = controller.getMemoryPreset()
    controller.close()
    return response
